...
final class ReCaptchaBinding
{
	...
	public static function bind(ReCaptchaProvider $provider, string $name = 'addReCaptcha'): void
	{
		...
		Container::extensionMethod($name, function (Container $container, string $name = 'hcaptcha', string $label = 'ReCaptcha', bool $required = true, ?string $message = null) use ($provider): ReCaptchaField {
